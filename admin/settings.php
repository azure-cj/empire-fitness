...
<body data-user-id="<?php echo htmlspecialchars($_SESSION['employee_id']); ?>"
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="employee_management.php" class="nav-item">
            ...
            <a href="member_applications.php" class="nav-item">
                <i class="fas fa-crown"></i>
                <span>Member Applications</span>
            </a>
            <a href="membership_plans.php" class="nav-item">
                <i class="fas fa-credit-card"></i>
                <span>Membership Plans</span>
            </a>
            
            <div class="nav-divider">BUSINESS</div>
            ...
            <a href="gym_activity.php" class="nav-item">
                <i class="fas fa-dumbbell"></i>
                <span>Gym Activity</span>
            </a>
